...
import {IStaticAxis, IStorage} from "../utils/types";
...
class Boundary implements IPolygon, IStaticAxis {
    ...
    public get axes(): Axis[] { return this._axes; }
    
    // IPolygonAdjustable stub (not used for boundaries)
    public adjustPolygon(point: Point, width: number, height: number, angle: number): void {
