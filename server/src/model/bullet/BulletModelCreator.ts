...
import {IWeapon} from "../../components/tank_parts/IWeapon";
...
export class BulletModelCreator {
    ...
    public static create(num: number, point: Point, angle: number, weapon: IWeapon): IBulletModel {
        ...
        return new BulletModel(bullet, entity);
    }
    ...
    private static createBullet(num: number): IBullet {
        switch (num) {
            case 0: return new LightBullet();
            case 1: return new MediumBullet();
            case 2: return new HeavyBullet();
            case 3: return new SniperBullet();
            case 4: return new GrenadeBullet();
            default: throw new Error(`Bullet model ${num} was not found`);
        }
    }
}
