...
export class MazeCreator {
    ...
    public static createMazeLvl2(wallHandlingManager: HandlingManager<WallElement, WallMovementManager>,
                                 wallMaterialNum: number) {
        MazeCreator._wallHandlingManagers = wallHandlingManager;
        MazeCreator._wallMaterialNum = wallMaterialNum;

        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[0], MazeCreator.GRID_LINES[1]), 2,
            true, true);
        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[2], MazeCreator.GRID_LINES[1]), 1,
            false, true);

        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[3], MazeCreator.GRID_LINES[0]), 2,
            true, true);
        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[3], MazeCreator.GRID_LINES[2]), 2,
            false, false);
        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[5], MazeCreator.GRID_LINES[1]), 2,
            true, true);
        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[5], MazeCreator.GRID_LINES[1]), 1,
            false, true);
        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[5], MazeCreator.GRID_LINES[3]), 1,
            false, true);

        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[4], MazeCreator.GRID_LINES[0]), 1,
            true, true);

        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[0], MazeCreator.GRID_LINES[4]), 1,
            true, true);

        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[1], MazeCreator.GRID_LINES[2]), 1,
            true, true);
        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[1], MazeCreator.GRID_LINES[3]), 3,
            false, true);
        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[2], MazeCreator.GRID_LINES[3]), 2,
            false, true);

        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[7], MazeCreator.GRID_LINES[0]), 1,
            true, true);

        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[6], MazeCreator.GRID_LINES[4]), 1,
            false, true);
        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[3], MazeCreator.GRID_LINES[4]), 5,
            true, true);
        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[7], MazeCreator.GRID_LINES[2]), 2,
            false, false);
        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[6], MazeCreator.GRID_LINES[2]), 2,
            true, false);
        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[8], MazeCreator.GRID_LINES[1]), 2,
            true, true);

        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[9], MazeCreator.GRID_LINES[0]), 3,
            true, true);
        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[9], MazeCreator.GRID_LINES[3]), 1,
            false, true);
        ...
        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[9], MazeCreator.GRID_LINES[4]), 1,
            true, true);
        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[9], MazeCreator.GRID_LINES[4]), 1,
            false, true);
    }
    public static createMazeLvl3(wallHandlingManager: HandlingManager<WallElement, WallMovementManager>,
                                 wallMaterialNum: number) {
        MazeCreator._wallHandlingManagers = wallHandlingManager;
        MazeCreator._wallMaterialNum = wallMaterialNum;

        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[1], MazeCreator.GRID_LINES[0]), 1,
            true, true);

        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[0], MazeCreator.GRID_LINES[2]), 2,
            true, true);

        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[0], MazeCreator.GRID_LINES[4]), 1,
            true, true);

        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[3], MazeCreator.GRID_LINES[0]), 3,
            true, true);
        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[2], MazeCreator.GRID_LINES[1]), 1,
            true, false);
        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[1], MazeCreator.GRID_LINES[3]), 2,
            true, false);

        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[2], MazeCreator.GRID_LINES[4]), 1,
            true, true);

        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[4], MazeCreator.GRID_LINES[3]), 2,
            true, true);
        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[3], MazeCreator.GRID_LINES[4]), 1,
            true, false);

        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[6], MazeCreator.GRID_LINES[0]), 3,
            true, true);
        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[4], MazeCreator.GRID_LINES[1]), 2,
            true, false);
        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[6], MazeCreator.GRID_LINES[2]), 3,
            false, true);
        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[7], MazeCreator.GRID_LINES[1]), 1,
            true, false);
        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[9], MazeCreator.GRID_LINES[1]), 1,
            true, false);
        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[9], MazeCreator.GRID_LINES[1]), 1,
            false, true);

        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[8], MazeCreator.GRID_LINES[0]), 1,
            true, true);

        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[6], MazeCreator.GRID_LINES[4]), 1,
            false, true);
        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[5], MazeCreator.GRID_LINES[4]), 3,
            true, true);
        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[5], MazeCreator.GRID_LINES[2]), 2,
            true, false);
        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[4], MazeCreator.GRID_LINES[2]), 1,
            true, false);
        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[7], MazeCreator.GRID_LINES[3]), 1,
            true, false);

        MazeCreator.makeVertWallLine(new Point(MazeCreator.GRID_COLUMNS[9], MazeCreator.GRID_LINES[3]), 2,
            false, true);
        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[8], MazeCreator.GRID_LINES[3]), 2,
            true, true);

        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[10], MazeCreator.GRID_LINES[2]), 1,
            true, true);

        MazeCreator.makeHorWallLine(new Point(MazeCreator.GRID_COLUMNS[10], MazeCreator.GRID_LINES[4]), 1,
            true, true);
    }
}