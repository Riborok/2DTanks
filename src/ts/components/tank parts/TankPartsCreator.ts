...
export class TankPartsCreator {
    ...
    private static createHull(hullNum: number): IHull {
        switch (hullNum) {
            ...
            case 1:
                return new HullModel1();
            case 2:
                return new HullModel2();
            case 3:
                return new HullModel3();
            case 4:
                return new HullModel4();
            case 5:
                return new HullModel5();
            case 6:
                return new HullModel6();
            case 7:
                return new HullModel7();
            default:
    ...
    private static createTrack(trackNum: number): ITrack {
        switch (trackNum) {
            ...
            case 1:
                return new TrackModel1();
            case 2:
                return new TrackModel2();
            case 3:
                return new TrackModel3();
            default:
    ...
    private static createTurret(turretNum: number): ITurret {
        switch (turretNum) {
            ...
            case 1:
                return new TurretModel1();
            case 2:
                return new TurretModel2();
            case 3:
                return new TurretModel3();
            case 4:
                return new TurretModel4();
            case 5:
                return new TurretModel5();
            case 6:
                return new TurretModel6();
            case 7:
                return new TurretModel7();
            default:
    ...
    private static createWeapon(weaponNum: number): IWeapon {
        switch (weaponNum) {
            ...
            case 1:
                return new WeaponModel1();
            case 2:
                return new WeaponModel2();
            case 3:
                return new WeaponModel3();
            case 4:
                return new WeaponModel4();
            case 5:
                return new WeaponModel5();
            case 6:
                return new WeaponModel6();
            case 7:
                return new WeaponModel7();
            default:
