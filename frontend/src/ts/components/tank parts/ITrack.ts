...
export class TrackModel0 implements ITrack{
    ...
    private static readonly BACKWARD_DATA: MotionData = { finishSpeed: 1.55, force: 0.0195 }
...
export class TrackModel1 implements ITrack{
    ...
    private static readonly BACKWARD_DATA: MotionData = { finishSpeed: 1.8, force: 0.019 }
...
export class TrackModel2 implements ITrack{
    ...
    private static readonly BACKWARD_DATA: MotionData = { finishSpeed: 0.82, force: 0.027 }
...
export class TrackModel3 implements ITrack{
    ...
    private static readonly BACKWARD_DATA: MotionData = { finishSpeed: 0.78, force: 0.0125 }
